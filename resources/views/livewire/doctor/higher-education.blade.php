    ...
    <div class="row">
        <div class="col-md-10">
            <form wire:submit.prevent="store">
                <div class="row mt-2">
                    <div class="col-md-4">
                        <label for="country">Porgram Type</label>
                        <select class="form-control" id="programType" wire:model="">
        ...
        <div class="col-md-2">
            @include('livewire.doctor.partials.tabs', ['activeTab' => 'higher-education']);
        </div>
    </div>
</div>